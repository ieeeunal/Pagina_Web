...
const Login = () => {
	...
	useEffect(() => {
        ...
        console.log(colorSelected.toUpperCase())
    ...
    const bgImage = () => {
        let photo1;
        try{
            photo1 = require(`../Assets/chapters/${color.toUpperCase()}.png`);
        }catch(error){
            try{
                photo1 = require(`../Assets/chapters/${color.toUpperCase()}.jpeg`);
            }catch(error){
                try{
                    photo1 = require(`../Assets/chapters/${color.toUpperCase()}.jpg`);
                }catch(error){
                    photo1 = require(`../Assets/chapters/AESS.png`);
                }
            }
        }
        console.log(photo1)
    ...
    return (
        <>
            <Hero chapterName={color.toLowerCase()} backImage={photo} color2={`${color}-color-b}`} secondColor="Inactive">
